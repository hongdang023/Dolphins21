...
const DICTIONARY = {
  vi: {
    ...
    sort_priority: 'Ưu tiên',
    sort_importance: 'Trọng số',
    sort_health: 'Thế mạnh',
    sort_risk: 'Rủi ro',
    sort_model_order: 'Thứ tự chuẩn',
    sort_priority_tip: 'Ưu tiên hành động: Ghim trọng tâm + Đang có mục tiêu + Điểm thấp cần cải thiện trước.',
    sort_importance_tip: 'Nền tảng cốt lõi: Ưu tiên năng lực tiên quyết về Quản trị lớp học & Mối quan hệ (TC1, TC5.1, TC5.2).',
    sort_health_tip: 'Độ vững vàng: Xếp điểm từ Cao xuống Thấp (Stage 4.0 → 1.0) hiển thị vùng thế mạnh.',
    sort_risk_tip: 'Vùng cảnh báo: Năng lực điểm rất thấp (Stage 1.0 - 1.5) hoặc chưa từng được đánh giá.',
    sort_model_order_tip: 'Mục lục chuẩn: Xếp tuần tự theo cấu trúc khung Building 21 (TC1.1 → TC5.6).',
  ...
  en: {
    ...
    sort_health: 'Health',
    sort_risk: 'Risk',
    sort_model_order: 'Model order',
    sort_priority_tip: 'Action Priority: Pinned items, active goals, and lowest scores needing immediate focus.',
    sort_importance_tip: 'Foundational Core: Prioritizes prerequisite competencies in relationships and safe environment (TC1, TC5.1, TC5.2).',
    sort_health_tip: 'Mastery Areas: Sorted from Highest to Lowest scores (Stage 4.0 → 1.0) showing your strengths.',
    sort_risk_tip: 'Risk Alert: Competencies with critical low scores (Stage 1.0 - 1.5) or unassessed items.',
    sort_model_order_tip: 'Standard Order: Sequential order from the Building 21 framework (TC1.1 → TC5.6).',
